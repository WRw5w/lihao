...
const GUIDE_ORDER = [
  ...
  "pred_results_ortho_clmix_tta_balanced.zip",
  ...
  "pred_results_ortho_ot_tta_balanced.zip",
  "pred_results_ortho_otknn_tta_balanced.zip",
  "pred_results_ortho_lp08_tta_balanced.zip",
  "pred_results_ortho_lp095_tta_balanced.zip",
  "pred_results_ortho_divmix5_tta_balanced.zip",
  "pred_results_ortho_divmix7_tta_balanced.zip",
  "pred_results_ortho_cb05_tta_balanced.zip",
  "pred_results_ortho_cb10_tta_balanced.zip",
  "pred_results_ortho_cutmix_tta_balanced.zip",
  "pred_results_ortho_erase_tta_balanced.zip",
